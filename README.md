...
Steps
Step	Command
1	Save code as age_calculator.c
2	Open terminal/command prompt
3	Compile: gcc age_calculator.c -o age_calculator
4	Run: ./age_calculator (Mac/Linux) or age_calculator.exe (Windows)
Quick Compile & Run (Linux/Mac)
bash

gcc age_calculator.c -o age_calculator && ./age_calculator

Key Concepts Learned
Concept	Symbol/Keyword	How Used
Header file	#include	Adds stdio.h library
Constant	#define	Defines CURRENTYEAR = 2026
Print output	printf()	Displays messages
Take input	scanf()	Reads birth year
Integer variable	int	Stores yearborn and age
If statement	if()	Checks if year > 2026
Else statement	else	Handles valid years
Modulo operator	%	Checks leap year (remainder after division)
Equal to	==	Compares if remainder is 0
New line	\n	Creates line breaks
Modulo Operator Explained
text

2000 ÷ 4 = 500 remainder 0  → 2000 % 4 = 0  → Leap Year ✓
2001 ÷ 4 = 500 remainder 1  → 2001 % 4 = 1  → Not Leap Year ✗
2002 ÷ 4 = 500 remainder 2  → 2002 % 4 = 2  → Not Leap Year ✗
2003 ÷ 4 = 500 remainder 3  → 2003 % 4 = 3  → Not Leap Year ✗
2004 ÷ 4 = 501 remainder 0  → 2004 % 4 = 0  → Leap Year ✓

Possible Improvements

    Validate negative years (can't be born before year 0)

    Add age restrictions (max realistic age 120)

    Use loop to ask again for invalid input

    Fix century rule (Years divisible by 100 are NOT leap years unless divisible by 400)

        Example: 1900 % 4 = 0 but NOT a leap year

    Convert to web version (HTML/JavaScript) for online use

Enhanced Leap Year Logic (Optional)
c
...
Wrong age calculation	Using age = yearborn - CURRENTYEAR	Use CURRENTYEAR - yearborn
Leap year always true	Using = instead of ==	Use == for comparison
No output	Missing \n	Add new line characters
Strange number output	Printing &yearborn in printf	Remove & in printf (keep in scanf)
Try Online
...
Created as a learning project for C programming - covers user input, conditionals, arithmetic, and modulo operations.
text
